...
public class Dialogue {
	...
	public static void main(String[] args) throws IOException {
		...
		barberList.add(new Barber("x - Xerxes"));
		barberList.add(new Barber("u - Ulla-Märta"));
		barberList.add(new Barber("z - Zeke"));
		barberList.add(new Barber("y - Ylva"));
		
		do {
			System.out.println("Välj frisör genom att ange bokstav\n0. Avsluta\n");
		...
		do {
			System.out.println(chosenBarber.getBarberName());
			...
			case "2":
				...
				// Namn på personen som vill boka tid för med koll på att man
				...
				// Loop för att tvinga användaren att ange datum i rätt format
				// (OKDate)
				do {
					try {
						...
						// Skicka tiden för kontroll om den är tillgänglig eller
						// ej
						bh.checkAvailability(myTime);
						// så här föreslog Eclipse att det skulle se ut efter
						// ett antal tillägg i koden
			...
			case "9":
				...
				// iterationer...
				// System.out.println("Vill du lägga upp tiden som stående varje
				// dag ?");
